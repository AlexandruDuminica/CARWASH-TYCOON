...
Car Wash Tycoon este un joc simplu de tip tycoon in care incepi cu resurse monetare de baza si cu o spalatorie de masini
basic. Acesta este un joc de simulare și management (tycoon) bazat pe text, în care scopul tău este să transformi o mică
spălătorie auto de cartier în cel mai profitabil imperiu de curățenie auto din oraș, reinvestindu-ti profitul si
upgradand echipamentele de curatare.
...
- [ ] definirea a minim **3-4 clase** folosind compunere cu clasele definite de voi; moștenirile nu se iau în
  considerare aici
...
- [ ] `operator<<` pentru **toate** clasele pentru afișare (`std::ostream`) folosind compunere de apeluri cu
  `operator<<`
- [ ] cât mai multe `const` (unde este cazul) și funcții `private`
- [ ] implementarea a minim 3 funcții membru publice pentru funcționalități netriviale specifice temei alese, dintre
